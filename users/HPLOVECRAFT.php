...
<html>
	...
	<head>
		<?php
			...
			if ($notcon == null) {
				$find = $conn->query("SELECT name,".$_COOKIE['lang']." FROM users WHERE nick='HPLOVECRAFT'");
				$i = $find->fetch_assoc();
	...
	<body>
		...
		<div id='bio'>
			...
			pelo autor. Lovecraft era assumidamente conservador e anglófilo, o que pode ser observado em seu poema An American To Mother England,[1] publicado em janeiro de 1916.[1] <br />
			...
			muitas vezes desafiando os valores do Iluminismo, do Romantismo, do Cristianismo e do Humanismo.[2][3] Os protagonistas de Lovecraft eram o oposto dos <br />
			...
			tem exercido "uma influência incalculável sobre sucessivas gerações de escritores de ficção de horror"[4] e Stephen King classificou o escritor como <br />
			"o maior praticante do século XX do conto de horror clássico".[5][nota 1] <br />
			<br />
