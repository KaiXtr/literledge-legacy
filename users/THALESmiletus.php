...
<html>
	...
	<body>
		...
		<div id='bio'>
			<?php
				if ($_COOKIE['lang'] == 'pt') {
					echo "Tales de Mileto, (em grego: Θαλῆς ὁ Μιλήσιος; c.624 — 546 a.C.[1][2][3][4]) foi um filósofo, matemático, engenheiro, homem de negócios e astrônomo da Grécia Antiga,[5] considerado, por alguns, o primeiro filósofo ocidental.[1][6] De ascendência fenícia, nasceu em Mileto, antiga colônia grega, na Ásia Menor, atual Turquia.[1][2]
