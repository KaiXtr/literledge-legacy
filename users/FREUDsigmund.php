...
<html>
	...
	<head>
		<?php
			...
			if ($notcon == null) {
				$find = $conn->query("SELECT name,".$_COOKIE['lang']." FROM users WHERE nick='FREUDsigmund'");
				$i = $find->fetch_assoc();
	...
	<body>
		...
		<div id='bio'>
			<div lang='pt-br'>
				Sigmund Schlomo Freud[2] (Freiberg in Mähren, 6 de maio de 1856 – Londres, 23 de setembro de 1939[3]; nascido Sigismund, mas mudou o primeiro nome em 1878[4]) foi um médico neurologista e psiquiatra criador da psicanálise. Freud nasceu em uma família judaica, em Freiberg in Mähren, na época pertencente ao Império Austríaco (atualmente, a localidade é denominada Příbor, e pertence à República Checa).[5]
