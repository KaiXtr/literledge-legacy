...
<html>
	...
	<head>
		<?php
			...
			if ($notcon == null) {
				$find = $conn->query("SELECT pt,".$_COOKIE['lang']." FROM users WHERE nick='MARXkarl'");
				$i = $find->fetch_assoc();
	...
	<body>
		...
		<div id='bio'>
			<?php
				if ($_COOKIE['lang'] == 'pt') {
					echo "
			Karl Marx[nota 1] (Tréveris, 5 de maio de 1818 — Londres, 14 de março de 1883) foi um filósofo, sociólogo, historiador, economista, jornalista e revolucionário <br />
			 ...
			 a base para muito do entendimento atual sobre o trabalho e sua relação com o capital, além do pensamento econômico posterior. Publicou vários livros <br />
			...
			a atividade econômica e social. Também fez campanha para o socialismo e tornou-se uma figura significativa na Associação Internacional dos Trabalhadores. <br />
			<br />
			...
			para a produção) e que o Estado foi criado para proteger os interesses da classe dominante, embora seja apresentado como um instrumento que representa o <br />
			...
			à sua autodestruição e substituição por um novo sistema: o socialismo. Ele argumentava que os antagonismos no sistema capitalista, entre a burguesia e o proletariado, <br />
