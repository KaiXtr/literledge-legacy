...
<html>
	...
	<head>
		<?php
			...
			if ($notcon == null) {
				$find = $conn->query("SELECT name,".$_COOKIE['lang']." FROM users WHERE nick='VERNEjules'");
				$i = $find->fetch_assoc();
	...
	<body>
		...
		<div id='bio'>
			Jules Gabriel Verne, conhecido nos países de língua portuguesa por Júlio Verne (Nantes, 8 de fevereiro de 1828 — Amiens, 24 de março de 1905), foi um escritor francês.[1] <br />
			<br />
			Júlio Verne foi o primogênito dos cinco filhos de Pierre Verne, advogado,[1] e Sophie Allote de la Fuÿe, esta de uma família burguesa de Nantes.[2] <br />
			...
			tendo escrito mais de 100 livros.[3] <br />
			<br />
