...
<html>
	...
	<head>
		<?php
			...
			if ($notcon == null) {
				$find = $conn->query("SELECT name,".$_COOKIE['lang']." FROM users WHERE nick='HUMEdavid'");
				$i = $find->fetch_assoc();
	...
	<body>
		...
		<div id='bio'>
			<div class='manlan' lang='pt'>
				David Hume (Edimburgo, 7 de maio (ou 26 de abril-Antigo) de 1711 – Edimburgo, 25 de Agosto de 1776) foi um filósofo, historiador e ensaísta britânico nascido na Escócia que se tornou célebre por seu empirismo radical e seu ceticismo filosófico. Ao lado de John Locke e George Berkeley, David Hume compõe a famosa tríade do empirismo britânico, sendo considerado um dos mais importantes pensadores do chamado iluminismo escocês e da própria filosofia ocidental.[1][2]
