...
<html>
	...
	<body>
		...
		<div id='bio'>
			<?php
				if ($_COOKIE['lang'] == 'pt') {
					echo "Pitágoras de Samos em grego: Πυθαγόρας ὁ Σάμιος, ou apenas Πυθαγόρας; Πυθαγόρης em grego jônico; c. 570 – c. 495 a.C.) foi um filósofo e matemático grego jônico creditado como o fundador do movimento chamado Pitagorismo. A maioria das informações sobre Pitágoras foram escritas séculos depois que ele viveu, de modo que há pouca informação confiável sobre ele. Nasceu na ilha de Samos e viajou o Egito e Grécia, em 520 a.C. voltou a Samos. Cerca de 530 a.C., mudou-se para Crotona, na Magna Grécia.";
				}
				if ($_COOKIE['lang'] == 'en') {
