	...
	<body>
		...
		<div id='bio'>
			<?php
				if ($_COOKIE['lang'] == 'pt') {
					echo "
			Friedrich Engels (pronúncia em alemão: [ˈfʁiːdʁɪç ˈʔɛŋl̩s]; Barmen, 28 de novembro de 1820 — Londres, 5 de agosto de 1895) foi um empresário industrial e teórico revolucionário prussiano, nascido na atual Alemanha, que junto com Karl Marx fundou o chamado socialismo científico ou marxismo. Seu pai era dono de uma grande indústria têxtil em Salford, Inglaterra.
