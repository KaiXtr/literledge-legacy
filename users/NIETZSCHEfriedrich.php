...
<html>
	...
	<head>
		<?php
			...
			if ($notcon == null) {
				$find = $conn->query("SELECT pt,".$_COOKIE['lang']." FROM users WHERE nick='NIETZSCHEfriedrich'");
				$i = $find->fetch_assoc();
	...
	<body>
		...
		<div id='bio'>
			...
			crítico cultural, poeta e compositor prussiano do século XIX, nascido na atual Alemanha. Escreveu vários textos criticando a religião, a moral, <br />
			...
			quão socialmente predominantes essas ideias poderiam ser. Seu questionamento radical do valor e da objetividade da verdade tem sido o foco de extenso comentário <br />
			...
			início do século XX, que usaram estes conceitos como pontos de partida para o desenvolvimento de suas filosofias. Mais recentemente, as reflexões de Nietzsche <br />
			...
			quatro anos, foi nomeado para a cadeira de Filologia Clássica na Universidade de Basileia, a pessoa mais jovem a ter alcançado esta posição. <br />
			...
			paresia geral atípica devido a sífilis terciária, mas este diagnóstico vem entrado em questão. Nietzsche viveu seus últimos anos sob os cuidados de sua <br />
			...
			associado com o militarismo alemão e o nazismo, mas estudiosos posteriores do século XX vêm tentando neutralizar esse equívoco de suas ideias. <br />
			<br />
