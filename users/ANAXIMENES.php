...
<html>
	...
	<body>
		...
		<div id='bio'>
			<?php
				if ($_COOKIE['lang'] == 'pt') {
					echo "Anaxímenes de Mileto[1] (Grego: Άναξιμένης), 588-524 a.C., foi um filósofo pré-socrático do Período Arcaico, ativo na segunda metade do século VI a.C..[2][3] Anaxímenes, tal como outros na sua escola de pensamento, praticou o materialismo monista.[4][3] Esta tendência para identificar uma específica realidade composta de um elemento material constitui o âmago das contribuições que deu fama a Anaxímenes.
