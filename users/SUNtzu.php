	...
	<body>
		...
		<div id='bio'>
			<?php
				if ($_COOKIE['lang'] == 'pt') {
					echo "
			Sun Tzu (chinês simplificado: 孙武; chinês tradicional: 孫武; pinyin: Sūn Wǔ) (544 a.C. - 496 a.C.) foi um general, estrategista e filósofo chinês e principal nome relacionado a escola militar de filosofia chinesa. Ele é mais conhecido por seu tratado militar, A Arte da Guerra, composto por 13 capítulos de estratégias militares.
