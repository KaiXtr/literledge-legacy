...
De seus escritos restaram poucos fragmentos (encontrados em obras posteriores), os quais geraram grande número de obras explicativas.";
				...
				if ($_COOKIE['lang'] == 'en') {
					echo "Heraclitus of Ephesus (/ˌhɛrəˈklaɪtəs/;[1] Greek: Ἡράκλειτος ὁ Ἐφέσιος, translit. Hērákleitos ho Ephésios; c. 535 – c. 475 BC, fl. 504/3 BC – 501/0 BC)[2] son of Bloson,[2] was a pre-Socratic Ionian Greek philosopher, and a native of the city of Ephesus, in modern-day Turkey and then part of the Persian Empire.
