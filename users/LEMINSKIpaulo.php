	...
	<body>
		...
		<div id='bio'>
			<?php
				if ($_COOKIE['lang'] == 'pt') {
					echo "
			Paulo Leminski Filho (Curitiba, 24 de agosto de 1944 — Curitiba, 7 de junho de 1989) foi um escritor, poeta, crítico literário, tradutor e professor brasileiro.Tinha uma poesia marcante, pois inventou um jeito próprio de escrever, com trocadilhos, brincadeiras com ditados populares e influência do haicai, além de abusar de gírias e palavrões, tudo de forma bastante instigante. Sob a influência da cultura japonesa, mais precisamente da forma do haicai, de Matsuo Basho, que significa  “hai = brincadeira, gracejo e kai = harmonia, realização”, há destaque para a concisão e objetividade, com seus textos curtos. Leminski era tão influenciado pela cultura japonesa que, além de ser faixa preta em judô, escreveu uma biografia de Basho.
			<br />
