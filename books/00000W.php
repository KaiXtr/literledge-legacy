		...
		<div id='bookinfo'>
			...
			<div id='review'>
				<?php
					...
					O próprio título da obra, se analisado corretamente, nos dará pistas importantes da mensagem que Graciliano quer passar: \"Vidas\"e opõe a \"Secas\"ois a primeira tem sentido de abundância, enquanto, a segunda, de vazio, de falta, configurando um paradoxo (ou \"oxímoro\"oposição de ideias resultando em uma construção de sentido ilógico). Além disso, denotativamente, o adjetivo \"secas\"e refere a \"vidas\"e, dessa forma, teria o sentido de que a família sofre com a seca. Por outro lado, conotativamente, pode-se relacionar aquele adjetivo a uma vida privada, miserável.
					<hr>
					<a name='goto2'></a>
					<h1> Personagens </h1>
					<ul>
					...
					No final, o desejo \"vitorioso\"e Sinha Vitória: rumo à cidade grande, Fabiano imagina as dificuldades pelas quais passarão, mas também pensa os \"meninos na escola, aprendendo coisas difíceis e necessárias\"
					...
					A cachorra Baleia é um membro da família. O nome \"Baleia\" uma espécie de alusão à morte da cachorra. Pois Graciliano pretendia a morte dela desde o começo (o capítulo de sua morte era um conto): Uma baleia no sertão morreria.
					...
					Ao ser sacrificada, por suspeita de cólera, Baleia vislumbra o \"céu dos cachorros, cheio de preás\"					</ul>
					<hr>
					<a name='goto3'></a>
					<h1> Curiosidades </h1>
					<ul>
