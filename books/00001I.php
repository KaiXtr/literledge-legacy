		...
		<div id='bookinfo'>
			...
			<div id='review'>
				<?php
					...
					<a name='goto1'></a>
					<h1> Resenha </h1>
					Animal Farm (Brasil: A Revolução dos Bichos /Portugal: O Porco Triunfante/O Triunfo dos Porcos/A Quinta dos Animais[1]) é um romance satírico do escritor inglês George Orwell, publicado no Reino Unido em 17 de agosto de 1945 e apontado pela revista americana Time entre os cem melhores da língua inglesa. A sátira feita pelo livro à União Soviética comunista obteve o 31º lugar na lista dos melhores romances do século XX organizada pela Modern Library List.[2]
