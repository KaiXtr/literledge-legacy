...
<html>
	...
	<head>
		<?php
			...
			if ($notcon == null) {
				$find = $conn->query("SELECT ".$_COOKIE['lang']." FROM translations WHERE fkey='000013'");
				$i = $find->fetch_assoc();
				$v = $i[$_COOKIE['lang']].' - ';
			}
	...
	<body>
		...
		<div id='bookinfo'>
			<?php $book = '000013'; $ech = '1'; include '../design/bookinfo.php'; ?>
			<div id='review'>
				<?php
					if ($_COOKIE['lang'] == 'pt') {
						echo "
					...
					<h1> Adaptações </h1>
					<ul>
					<li><a href='https://m.imdb.com/title/tt0000417/'>Le Voyage dans La Lune (1902) - Georges Méliès</a></li>
					</ul>
					<hr>
					<a name='goto4'></a>
					<h1> Curiosidades </h1>
					...
					<li>descrição do módulo com três astronautas;[5]</li>
					<li>O local de partida da nave em Tampa, nos EUA, apenas a 30 km de distância de onde realmente sairia a Apollo 11 cerca de cem anos depois</li>
					<li>O nome de alguns astronautas, como Michel Ardan, é semelhante ao Michael de Michael Collins; e Ardan, ao do astronauta Edwin Aldrin).</li>
					</ul>
					<hr>
						";
					}
			...
			<?php $book = '000013'; $ech = '2'; include '../design/bookinfo.php'; ?>
		</div>
