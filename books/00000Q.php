		...
		<div id='bookinfo'>
			...
			<div id='review'>
				<div class='manlan' lang='pt'>
					<a name='goto1'></a>
					<h1> Resenha </h1>
					O Chamado de Cthulhu é um conto de horror do escritor norte-americano H. P. Lovecraft, contando a investigação sobre um ser extraterrestre e dos "antigos" que na mitologia "lovecraftiana" seriam criaturas cósmicas, vindas à Terra antes desta abrigar a vida.[1]
