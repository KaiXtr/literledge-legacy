...
<html>
	...
	<head>
		<?php $v = 'O Pequeno Príncipe - '; include '../design/metadata.php'; ?>
	</head>
		...
		<div id='bookinfo'>
			...
			<div id='review'>
				<div class='manlan' lang='pt'>
					<a name='goto1'></a>
					<h1> Resenha </h1>
					Le Petit Prince (pronúncia em francês: ​[lə.pə.tiˈpʁɛ̃s]), também conhecido como O Principezinho (título em Portugal) ou O Pequeno Príncipe (título no Brasil) é uma obra do escritor, ilustrador e aviador francês Antoine de Saint-Exupéry,[2] publicada em 1943 nos Estados Unidos.
					...
					Em Le Petit Prince, seu narrador, o aviador, fala sobre ter ficado preso num deserto após seu avião ter caído. Essa situação foi baseada num incidente com o autor no Saara, descrito com detalhes em seu livro de memórias Terre des hommes em 1939.[8]
					...
					<li>Na década de 80 foi lançada uma série de desenhos animados chamada As Aventuras do Pequeno Príncipe. A série foi feita pelo estúdio de animação "Vóvó Chantre" e foi ao ar pela primeira vez no Japão em 1978 sob o título Hoshi no Ōjisama Puchi Purinsu (星の王子さま　プチ・プリンス? Prince of the Stars: Petit Prince).[9][10]</li>
