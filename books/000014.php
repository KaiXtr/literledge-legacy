		...
		<div id='bookinfo'>
			...
			<div id='review'>
				<?php
					...
					Por bastante tempo discutiu-se a autoria das Cartas Chilenas. A dúvida só acabou após estudos de Afonso Arinos (1940) e, principalmente, de Rodrigues Lapa, comparando a obra com cada um dos elementos do \"Grupo Mineiro\", possíveis autores, quando se concluiu que o verdadeiro autor é Tomás Antônio Gonzaga, que ocupara o cargo de Ouvidor e que sofrera contrariedades pelos atos do governador. Assim,Critilo é ele mesmo e Doroteu, Cláudio Manuel da Costa. Manoel Bandeira também apontou Gonzaga como autor, em trabalho publicado no número 22, de abril de 1940, da Revista do Brasil. Especula-se que a obra tenha sido influenciada por Cartas Persas, de Montesquieu.
					<hr>
					<a name='goto2'></a>
					<h1> Personagens </h1>
					<ul>
