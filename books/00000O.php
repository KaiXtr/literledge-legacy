		...
		<div id='bookinfo'>
			...
			<div id='review'>
				<?php
					...
					Dom Quixote e Sancho Pança representam valores distintos, embora sejam participantes do mesmo mundo. É importante compreender a visão irônica que o romancista tem do mundo moderno, o fundo de alegria que está por detrás da visão melancólica e a busca do absoluto. São mundos completamente diferentes. Sancho Pança o fiel escudeiro de Dom Quixote é definido por Cervantes com\"Homem de bem, mas de pouco sal na moleirinha\"É o representante do bom senso e é para o mundo real aquilo que Dom Quixote é para o mundo ideal. Por fim, a história também é apresentada sob a forma de novela realista: ao regressar a seu povoado, Dom Quixote percebe que não é um herói, mas que não há heróis.
					<hr>
					<a name='goto2'></a>
					<h1> Personagens </h1>
					<ul>
