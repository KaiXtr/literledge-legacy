			...
			<div id='review'>
				<?php
					...
					if ($_COOKIE['lang'] == 'en') {
						echo "<a name='goto1'> </a>
					<h1> Review </h1>
					The Divine Comedy [1] (in Italian: Divina Commedia, originally Comedìa and later called Divine Comedy by Giovanni Boccaccio) [2] is a poem of epic and theological bias in Italian and world literature, written by Dante Alighieri in the century XIV and divided into three parts: Hell, Purgatory and Paradise.
					...
					There is no record of the exact date on which it was written, but the most recognized opinions assure that Hell may have been composed between 1304 and 1307-1308, Purgatory from 1307-1308 to 1313-1314 and, finally, Paradise, from 1313-1314 to 1321 (this last date coincides with the death of Dante [3]).

					The poem - perhaps the greatest in the West - describes a journey where several events take place. [4] Its strength is in the wealth of allegories, which make the story timeless.
					...
					Some see this work as the Summa Teológica, by São Tomás de Aquino, in verse [5].

					Great painters from different eras created illustrations for the Divine Comedy, standing out Botticelli, Gustave Doré and Dalí [1]. [6]
					...
					Explanations about the meaning of the symbolism in the work are complex and much debated, as is the case of knowing exactly the meaning of the beloved Beatriz: would she be just a carnal love, the state, the church, the metaphysical love or another? Dante himself confirms this complexity by stating that the work has four overlapping meanings: literal, moral, allegorical and mystical. [7]

					Each of the three parts of the poem (Inferno, Purgatório and Paraíso) is divided into 33 songs, with one more as an introduction, the work adds 100 songs, a number that would mean the perfection of perfection. In addition to Dante himself, three are the main characters: Virgílio, guide in hell and purgatory, Beatriz guide in earthly paradise and São Bernardo, guide in the celestial spheres. The work also adds 14,233 verses in, from then on, called \"Dantesque triplets\". [8]
					...
					if ($_COOKIE['lang'] == 'es') {
						echo "<a name='goto1'> </a>
					<h1> Revisión </h1>
					La Divina Comedia [1] (en italiano: Divina Commedia, originalmente Comedia y luego llamada Divina Comedia de Giovanni Boccaccio) [2] es un poema de sesgo épico y teológico en la literatura italiana y mundial, escrito por Dante Alighieri en el siglo XIV y dividido en tres partes: Infierno, Purgatorio y Paraíso.
					...
					No hay registro de la fecha exacta en la que se escribió, pero las opiniones más reconocidas aseguran que el Infierno pudo haber sido compuesto entre 1304 y 1307-1308, el Purgatorio de 1307-1308 a 1313-1314 y, finalmente, el Paraíso, de 1313-1314 a 1321 (esta última fecha coincide con la muerte de Dante [3]).

					El poema, quizás el más grande de Occidente, describe un viaje en el que tienen lugar varios eventos. [4] Su fuerza está en la riqueza de alegorías, que hacen que la historia sea atemporal.
					...
					Algunos ven este trabajo como la Summa Teológica, de Santo Tomás de Aquino, en el verso [5].

					Grandes pintores de diferentes épocas crearon ilustraciones para la Divina Comedia, destacando Botticelli, Gustave Doré y Dalí [1]. [6]
