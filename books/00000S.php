...
<html>
	...
	<head>
		<?php $v = 'Os Lusíadas - '; include '../design/metadata.php'; ?>
	</head>
		...
		<div id='bookinfo'>
			...
			<div id='review'>
				<div class='manlan' lang='pt'>
					<a name='goto1'></a>
					<h1> Resenha </h1>
					Os Lusíadas é uma obra de poesia épica do escritor português Luís Vaz de Camões, considerada a "epopeia portuguesa por excelência". Provavelmente concluída em 1556, foi publicada pela primeira vez em 1572 no período literário do Humanismo, três anos após o regresso do autor do Oriente.
					...
					Em 2018, João Morgado edita "O Livro do Império"[10], que narra a escrita e impressão d'Os Lusíadas, e os meandros da corte e do Santo Ofício que autorizaram uma publicação tão polémica.(ISBN 978-989-724-451-3)
					</ul>
					<hr>
					</div>
			</div>
